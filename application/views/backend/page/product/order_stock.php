	    						...
	    						<dd>
	    							<div class="form-group">
	    								<select class="form-control" name="auto_fill">
	    									<option value="AUTOFILL">Auto-fill from reorder point</option>
	    									<option value="NOAUTOFILL">Don't Auto Fill</option>
	    								</select>
	    								<p class="help-block">Auto fill your order with products that have low stock levels (500 product max).</p>
	    							</div>
	    						</dd>
	    						<dt>Import order</dt>
	    						<dd>
